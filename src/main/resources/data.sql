...
VALUES ('Grójecka 28', 18, 0,'Warszawa','dolek@wp.pl', 'Piotr','Pawlak', 1000, '2015-06-12'),
       ('Zielona 28', 28, 1, 'Kraków', 'ek@wp.pl', 'Paweł', 'Kaczyński', 2000, '2012-03-01'),
       ('Grójecka 28', 45, 1, 'Warszawa', 'zlek@wp.pl','Anna','Pawlak', 3000,'2019-12-12'),
...
INSERT INTO Cars(employee_id, brand, model, registration_date)
...
INSERT INTO Printers(brand, color, laser, model)
VALUES ('Hewlett Packard', true, true, '1234h'),
       ('EasyJet', true, false, 'asd'),
       ('Optimus', false, false, 'Prime');

INSERT INTO Employees_Printers(printer_id, employee_id)
VALUES (1, 3),
       (1, 4),
       (1, 5),
       (1, 6),
